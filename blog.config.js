...
const BLOG = {
  ...
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: '',
  CONTACT_TELEGRAM: 'https://t.me/emerald2021',
  ...
  // 无关紧要的配置
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Jade’s BLOG', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '欢迎来整点薯条🍟🍔🥤', // 站点描述，被notion中的页面描述覆盖
